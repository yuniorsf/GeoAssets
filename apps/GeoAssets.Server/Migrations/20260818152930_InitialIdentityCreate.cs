    ...
    public partial class InitialIdentityCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AzureObjectId = table.Column<string>(type: "character varying(36)", maxLength: 36, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PolicyRequirements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PolicyRequirements_Policies_PolicyId",
                        column: x => x.PolicyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PolicyRequirements_PolicyId",
                table: "PolicyRequirements",
                column: "PolicyId");
